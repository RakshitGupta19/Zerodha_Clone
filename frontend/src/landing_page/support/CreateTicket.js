        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Zerodha IDFC FIRST Back 3-in-1 Account</a><br/>
                ...
                <div className='col-4 p-5 mt-2'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Depository Participant (DP)</a><br/>
                ...
                <div className='col-4 p-5 mb-5'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Add Back Accounts</a><br/>
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>eMandates</a><br/>
                </div>
                <div className='col-4 p-5 mb-5'>
                    <h4><i class="fa fa-adjust" aria-hidden="true"></i> Console</h4>
                ...
                <div className='col-4 p-5 mb-5'>
                    <h4><i class="fa fa-gg-circle" aria-hidden="true"></i> Coin</h4>
