        ...
        <div className='container'>
            <div className='row pt-5 mt-5 text-center border-top'>
                <div className='col-8 p-4'>
                    <a href="" style={{textDecoration:"none"}}><h3 className='fs-5 mb-3'>Brokerage Calculator</h3></a>
                ...
                <div className='col-4 p-4'>
                    <a href='' style={{textDecoration:"none"}}><h3 className='fs-5 mb-3'>List of charges</h3></a>
                </div>
            </div>
        </div>
     );
